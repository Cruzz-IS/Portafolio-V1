...
const categories: Category[] = [
  ...
  },
  {
    ...
    skills: [
      {
        name: "Talend",
        icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/9e/Talend_Logo.svg/320px-Talend_Logo.svg.png",
      },
      {
        name: "Power BI",
  ...
  },
  {
    ...
    skills: [
      {
        name: "Cisco / CCNA",
        icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Cisco_logo_blue_2016.svg/320px-Cisco_logo_blue_2016.svg.png",
      },
      {
        name: "Huawei",
        icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e8/Huawei_Logo.svg/320px-Huawei_Logo.svg.png",
      },
      {
        name: "GNS3",
        icon: "https://avatars.githubusercontent.com/u/8014829?s=200&v=4",
      },
      {
        name: "Packet Tracer",
        icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Cisco_logo_blue_2016.svg/320px-Cisco_logo_blue_2016.svg.png",
  ...
  },
  {
    ...
    skills: [
      ...
      {
        name: "Copilot",
        icon: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Microsoft_365_Copilot_Icon.svg/320px-Microsoft_365_Copilot_Icon.svg.png",
      },
    ],
  },
];
