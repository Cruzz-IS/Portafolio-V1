...
const categories: Category[] = [
  ...
  },
  {
    ...
    skills: [
      { name: "Cisco / CCNA", icon: "/img/cisco-svgrepo-com.svg" },
      { name: "Huawei", icon: "/img/huawei-svgrepo-com.svg" },
      { name: "GNS3", icon: "/img/gns3_94911.svg" },
      { name: "Packet Tracer", icon: "/img/icons8-cisco-packet-tracer.svg" },
    ],
  },
  {
    title: "CI/CD & Gestión",
  ...
  },
  {
    ...
    skills: [
      { name: "Excel", icon: "/img/microsoft-excel-2013-logo-svgrepo-com.svg" },
      {
        name: "PowerPoint",
