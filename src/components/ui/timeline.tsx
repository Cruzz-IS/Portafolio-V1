...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full themeOne font-sans md:px-10" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        ...
        <p className="text-center text-slate-400 mb-4 text-lg">
          Un resumen de mi trayectoria profesional, destacando mis roles, responsabilidades y logros en cada posición.
        </p>
        {/* <p className="text-center text-slate-400 mb-16 text-lg max-w-sm">
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h3 className="hidden md:block text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl md:pl-20 font-bold textH3">
                {item.title}
              </h3>
            </div>

            <div className="relative pl-20 pr-4 md:pl-4 w-full">
              <h3 className="md:hidden block text-2xl mb-4 text-left font-bold textH3">
                {item.title}
              </h3>
              {item.content}{" "}
            </div>
