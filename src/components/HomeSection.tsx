  ...
  useEffect(() => {
    ...
    if (curChar < src.text.length) {
      const t = setTimeout(() => {
        setLines(prev => {
          const next = [...prev];
          next[curLine] = { text: src.text.slice(0, curChar + 1), color: src.color, done: false };
          return next;
        });
        setCurChar(c => c + 1);
      }, 24 + Math.random() * 22);
      ...
      setLines(prev => { const n=[...prev]; if(n[curLine]) n[curLine].done=true; return n; });
      const t = setTimeout(() => { setCurLine(l => l+1); setCurChar(0); }, 70);
      return () => clearTimeout(t);
    }
  }, [curLine, curChar]);
      ...
      {METEORS.map(m => (
        <div
          ...
          style={{
            ...
            background: 'linear-gradient(90deg, rgba(99,179,237,0) 0%, rgba(99,179,237,0.9) 50%, rgba(255,255,255,0.6) 100%)',
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div
        ...
        style={{
          top: '-15%', left: '-10%',
          background: 'radial-gradient(circle, #3b82f6 0%, #06b6d4 50%, transparent 75%)',
      ...
      <div
        ...
        style={{
          bottom: '-10%', right: '-5%',
          background: 'radial-gradient(circle, #06b6d4 0%, #8b5cf6 50%, transparent 75%)',
      ...
      <div
        ...
        style={{
          top: '30%', left: '40%',
          background: 'radial-gradient(circle, #8b5cf6 0%, #3b82f6 60%, transparent 80%)',
  ...
  return (
    <div className="absolute inset-0 pointer-events-none overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: 'repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(99,179,237,0.8) 4px)',
  ...
  return (
    <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
      {SYMBOLS.map((sym, i) => {
        ...
        const dur    = 5 + (i % 5);
        const delay  = i * 0.35;
        const bright = i % 3 === 0 ? 0.35 : i % 3 === 1 ? 0.20 : 0.12;
        return (
          <span
            key={i}
            ...
            style={{
              left, top,
              fontSize: `${size}px`,
              color: i % 2 === 0 ? `rgba(34,211,238,${bright})` : `rgba(99,179,237,${bright})`,
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden dark:bg-[#020818] bg-slate-50">
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(ellipse 80% 80% at 50% 50%, transparent 40%, rgba(2,8,20,0.4) 100%)',
        }}
      />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div
            ...
            style={{
              ...
              transition: 'opacity 1s ease 0.2s, transform 1s cubic-bezier(.16,1,.3,1) 0.2s',
            }}
          >
            {/* Badge disponible */}
            ...
            <div>
              <p className="font-mono textParTwo mb-2 tracking-widest uppercase text-xs">
                {t('hero.greeting')} &nbsp;<span className="dark:text-cyan-400 text-cyan-600">{'>'}_</span>
              </p>
              <h1
            ...
            <p className="text-base md:text-lg textParTwo leading-relaxed max-w-lg">
              ...
              escalables. Graduado de la{' '}
              <span className="dark:text-cyan-300 text-cyan-600 font-semibold">UNAH</span>{' '}
              ...
              {['Rust', 'FastAPI', 'React', 'Next.js', 'PostgreSQL', 'Docker'].map((tech, i) => (
                ...
                >
                  <span
                    ...
                    style={{
                      background: 'linear-gradient(90deg, transparent 0%, rgba(99,179,237,0.15) 50%, transparent 100%)',
          ...
          <div
            ...
            style={{
              opacity: loaded ? 1 : 0,
              transform: loaded ? 'translateX(0)' : 'translateX(50px)',
              transition: 'opacity 1s ease 0.4s, transform 1s cubic-bezier(.16,1,.3,1) 0.4s',
            }}
          >
            <div className="relative">
              ...
              >
                <span className="text-base">🦀</span>
                <span className="text-xs font-mono font-bold dark:text-orange-300 text-orange-600">JS Dev</span>
              </div>
            </div>
            ...
            >
              <div className="flex items-center gap-1.5 px-4 py-3 dark:bg-slate-900 bg-slate-700">
                ...
                <span className="ml-3 text-xs font-mono dark:text-slate-400 text-slate-300 tracking-wide">developer.ts</span>
                {/* Indicador activo */}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex flex-col items-center gap-1.5 animate-bounce">
        <span className="text-[10px] font-mono textParTwo tracking-[0.2em] uppercase">Ver más</span>
